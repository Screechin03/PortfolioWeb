            ...
            <div className="flex flex-col md:flex-row items-center space-y-10 md:space-x-10 px-10 overflow-x-auto snap-x snap-mandatory">
                {PROJECTS.map((project, index) => (
                    <motion.div
                        ...
                        initial={{ opacity: 0, x: "-95%", z: -50 }}
                        transition={{ duration: 0.5, ease: "easeOut" }}
                        className="snap-center flex-shrink-0 bg-transparent border p-8 rounded-lg shadow-lg max-w-[600px] w-full md:w-[600px] flex flex-col items-center"
                    >
